  ...
  return (
    <section className="bg-brand-black text-brand-red py-12 overflow-hidden relative border-t border-brand-red/20">
      ...
      <div className="container mx-auto relative z-10">
        {stats.map((stat, idx) => (
          <div key={stat.label} className="border-b border-brand-red/20 last:border-0 relative group">
            <div className="absolute inset-0 bg-brand-red/5 scale-y-0 group-hover:scale-y-100 transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] origin-bottom" />
            <motion.div
            ...
            >
              <div className="text-[20vw] md:text-[10vw] font-bold leading-none tracking-tighter flex items-start text-glitch tabular-nums">
