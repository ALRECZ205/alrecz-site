      ...
      <div className="container mx-auto text-center relative z-10">
        ...
        >
          ...
          <span className="inline-block mx-4 align-middle w-[15vw] h-[8vw] md:w-[12vw] md:h-[6vw] rounded-none overflow-hidden border border-brand-red relative group">
            ...
            <Image src="https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?q=80&w=1000&auto=format&fit=crop" fill sizes="15vw" className="object-cover grayscale contrast-125 brightness-75 group-hover:grayscale-0 transition-all duration-500" alt="" />
          </span>
          I help brands uncover their why 
          <span className="inline-block mx-4 align-middle w-[15vw] h-[8vw] md:w-[12vw] md:h-[6vw] rounded-none overflow-hidden border border-brand-red relative group">
            <div className="absolute inset-0 bg-brand-red/30 mix-blend-overlay z-10" />
            <Image src="https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&w=1000&auto=format&fit=crop" fill sizes="15vw" className="object-cover grayscale contrast-125 brightness-75 group-hover:grayscale-0 transition-all duration-500" alt="" />
          </span>
          <span className="text-outline">and scale it with creativity</span> 
          <span className="inline-block mx-4 align-middle w-[15vw] h-[8vw] md:w-[12vw] md:h-[6vw] rounded-none overflow-hidden border border-brand-red relative group">
            <div className="absolute inset-0 bg-brand-red/30 mix-blend-overlay z-10" />
            <Image src="https://images.unsplash.com/photo-1550684376-efcbd6e3f031?q=80&w=1000&auto=format&fit=crop" fill sizes="15vw" className="object-cover grayscale contrast-125 brightness-75 group-hover:grayscale-0 transition-all duration-500" alt="" />
          </span>
