import { Artwork } from '@/components/art-ai/types';

// Single source of truth for the archive's artwork catalog.
// Previously duplicated inline inside ArtAIPage.tsx; both the /art
// page and the homepage's Exhibitions/Transmissions previews import
// from here now.
...
export const LOST_BOYZ_ARTWORKS = ARTWORKS.filter((art) =>
  ['116', '117', '118', '119', '120', '121'].includes(art.id)
);
